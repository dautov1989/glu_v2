...
return [
    ...
    [
        ...
        'items' => [
            ...
            ['name' => 'Щи (250мл, средняя тарелка)', 'carbs' => 10],
            ['name' => 'Солянка (250мл)', 'carbs' => 8],
    ...
    [
        ...
        'color' => 'bg-purple-500',
        'items' => [
            ['name' => 'Апельсиновый сок (200мл)', 'carbs' => 22],
            ['name' => 'Яблочный сок (200мл)', 'carbs' => 24],
            ['name' => 'Виноградный сок (200мл)', 'carbs' => 30],
            ['name' => 'Томатный сок (200мл)', 'carbs' => 8],
            ['name' => 'Мультифрукт сок (200мл)', 'carbs' => 26],
            ['name' => 'Вишнёвый сок (200мл)', 'carbs' => 28],
            ['name' => 'Кола/Пепси (200мл)', 'carbs' => 22],
            ['name' => 'Лимонад (200мл)', 'carbs' => 20],
            ['name' => 'Квас (200мл)', 'carbs' => 12],
            ['name' => 'Компот (200мл)', 'carbs' => 18],
        ]
    ],
    [
        'name' => 'Овощи и салаты',
        ...
        'items' => [
            ...
            ['name' => 'Горошек зеленый (100г)', 'carbs' => 10],
            ['name' => 'Икра кабачковая (100г)', 'carbs' => 8],
        ]
    ],
    [
        ...
        'items' => [
            ...
            ['name' => 'Творог 5-9% (100г)', 'carbs' => 3],
            ['name' => 'Сметана 20% (50г)', 'carbs' => 2],
            ['name' => 'Снежок (200мл)', 'carbs' => 22],
            ['name' => 'Какао с молоком (200мл)', 'carbs' => 25],
        ]
    ],
    [
        'name' => 'Сладости',
        ...
        'items' => [
            ...
            ['name' => 'Варенье/Джем (1 ст.л.)', 'carbs' => 14],
        ]
    ],
];
