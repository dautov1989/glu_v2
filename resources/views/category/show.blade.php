        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6">
            ...
            @if($posts->count() > 0)
                <div x-data="{
                    ...
                    <h2 id="materials-start" class="text-lg font-semibold text-zinc-800 dark:text-zinc-200 flex items-center mb-4">
                    ...
                    <div class="flex items-center justify-between mb-4 gap-4">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" @click.away="open = false"
                                ...
                                <span class="sm:hidden">Сортировка</span>
                                <svg class="w-4 h-4 transition-transform text-zinc-500" :class="{ 'rotate-180': open }" fill="none"
                        ...
                        @foreach($posts as $post)
                            <article
                                ...
                                <div :class="{ 
                                    ...
                                    {{-- Meta --}}
                                    <div :class="{ 'mb-2': viewMode === 'grid', 'mb-1': viewMode === 'list' }" class="flex items-center text-[10px] sm:text-[11px] text-zinc-400 gap-2 whitespace-nowrap overflow-hidden text-ellipsis">
